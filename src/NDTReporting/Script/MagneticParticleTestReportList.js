...
//Page Functions
{
    $(document).ready(function () {
        ...
        $("#btnSearch").live('click', function (e) {
            GetAllMagneticParticleTestReports();
            e.preventDefault();
        });
    ...
    function GetAllMagneticParticleTestReports() {
        ...
        DoAjaxCall(handler, "DisplayAllMagneticParticleTestReports", "GetAllMagneticParticleTestReports", "", datatype, JSON.stringify(req));
    }
    ...
    function DisplayAllMagneticParticleTestReports(data, message) {
        //header
        var str = "<table style='width: 100%;' class='TableValue'>";

        str += "<tr><td colspan='10' class='TDHeader'><b>Magnetic Particle Test Report List</b></td></tr>";
        //Search Controls Row
        str += "<tr>" +
            ...
            "</tr>";
        //"<tr><td colspan='9' class='TDHeader'><b>Magnetic Particle Test Report List</b></td></tr>" +
        str += "<tr>" +
        ...
        for (var i = 0; i < data.TestRecordLightList.length; i++) {
            ...
            str += "</tr>";
            // onclick='PrintRadiographicWeldReport(" + data[i].ReportID + ")'
        }
        str += "<tr>";
    ...
    function DeleteReport(reportId) {
        if (confirm("Are you sure you want to delete the record?")) {
            DoAjaxCall(handler, "DeleteMagneticParticleTestReportSucess", "DeleteMagneticParticleTests", reportId, datatype, empty);
        }
    }

    function EditReport(reportId) {
        window.location.href = "MagneticParticleTestReport.aspx?ReportId=" + reportId;
    }
    function DeleteMagneticParticleTestReportSucess(data, message) {
    ...
    function RedirectToReportViewParams(data, message) {
        window.location.href = "MagneticParticleTestReportViewer.aspx";
    }
