...
//Page Functions
{
    $(document).ready(function () {
        ...
        $("#btnSearch").live('click', function (e) {
            GetAllLiquidPenetrantTestReports();
            e.preventDefault();
        });
    ...
    function GetAllLiquidPenetrantTestReports() {
        ...
        DoAjaxCall(handler, "DisplayAllLiquidPenetrantTestReports", "GetAllLiquidPenetrantTestReports", "", datatype, JSON.stringify(req));
    }
    ...
    function DisplayAllLiquidPenetrantTestReports(data, message) {
        //Header
        var str = "<table style='width: 100%;' class='TableValue'>" +
            "<tr><td colspan='10' class='TDHeader'> <b>Liquid Penetrant Test Report List</b> </td> </tr> ";
        //Search Controls Row
        str += "<tr>" +
        ...
        str += "<tr> " +
            ...
            "<td class='TDHeaderCell1'>LT Report No.</td> " +
            ...
            "<td class='TDHeaderCell1'>Print/Authorize</td> " +
            "</tr>";
    ...
    function DeleteReport(ReportID) {
        if (confirm("Are you sure you want to delete the record?")) {
            DoAjaxCall(handler, "DeleteLiquidPenetrantTestReportSucess", "DeleteLiquidPenetrantTests", ReportID, datatype, empty);
        }
    }

    function EditReport(ReportID) {
        window.location.href = "LiquidPenetrantTestReport.aspx?ReportId=" + ReportID;
    }
    function DeleteLiquidPenetrantTestReportSucess(data, message) {
    ...
    function RedirectToReportViewParams(data, message) {
        window.location.href = "LiquidPenetrantTestReportViewer.aspx";
    }
