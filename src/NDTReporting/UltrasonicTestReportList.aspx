<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true"
    CodeBehind="UltrasonicTestReportList.aspx.cs" Inherits="NDTReporting.UltrasonicTestReportList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" src="Script/UltrasonicTestReportList.js"></script>
    <script type="text/javascript" src="Scripts/jquery.inlinefieldlabel.min.js"></script>
