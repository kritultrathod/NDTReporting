...
CodeBehind="EditTemplate.aspx.cs" Inherits="NDTReporting.EditTemplate" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" src="Script/Createreport.js"></script>
        ...
        <table style='width: 100%; height: 100%;' class='TableValue'>
            ...
            <tr>
                <td colspan="2" align="center">
                    <input id="Button1" type="button" value="Display" class="classname" onclick="DisplayTemplateList();" />
