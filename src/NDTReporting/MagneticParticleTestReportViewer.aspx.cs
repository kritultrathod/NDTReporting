...
{
    public partial class MagneticParticleTestReportViewer : System.Web.UI.Page
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            string filePath = Server.MapPath("~/PDF/Report" + HTMLFileName);//Session["UserName"].ToString() + ".html"); //@"G:\Artha\NDTReporting\Report.html";
            ...
            DbMagneticParticleTest obj = new DbMagneticParticleTest();
            MagneticParticleTestTemplate objMagneticParticleTestTemplate = new MagneticParticleTestTemplate();

            objMagneticParticleTestTemplate = obj.GetMagneticParticleTestReportById(ReportId);

            string paramBuild = "id=" + objMagneticParticleTestTemplate.MagneticParticleTest.ReportId +
                "&location=" + objMagneticParticleTestTemplate.MagneticParticleTest.Location +
            "&client=" + objMagneticParticleTestTemplate.MagneticParticleTest.FabricatorName +
            "&contractno=" + objMagneticParticleTestTemplate.MagneticParticleTest.ContractNo +
            "&reportno=" + objMagneticParticleTestTemplate.MagneticParticleTest.ReportNo +
            "&description=" + objMagneticParticleTestTemplate.MagneticParticleTest.JobDescription +
            "&testdate=" + string.Format("{0:dd/MM/yyyy}", objMagneticParticleTestTemplate.MagneticParticleTest.DateofTesting) +
            "&contactperson=" + objMagneticParticleTestTemplate.MagneticParticleTest.ContactPerson;
        ...
        protected void btnAuthorize_Click(object sender, EventArgs e)
        {
            HandleError.HandleInternalError(() =>
            {
                ...
                if (ResultId > 0)
                {
                    Response.Redirect("MagneticParticleTestReportList.aspx?SubTestId=5");
                }
            },
            (m, ex) => { });
        }
