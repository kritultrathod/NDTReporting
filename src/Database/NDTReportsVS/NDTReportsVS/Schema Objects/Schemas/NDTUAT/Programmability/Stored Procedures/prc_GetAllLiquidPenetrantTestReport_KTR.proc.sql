CREATE PROCEDURE [NDTUAT].[prc_GetAllLiquidPenetrantTestReport_KTR]
	@CreatedBy as int,
    @pageIndex int = 1,  
    @PageSize int = 10,
...
SELECT
	...
	END DESC
	) AS RowId INTO #LiquidPenetrantExaminationTest
FROM NDTUAT.LiquidPenetrantExaminationTest T
...
SELECT
	@MyRowCount = COUNT(1)
FROM #LiquidPenetrantExaminationTest
