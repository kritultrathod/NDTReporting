CREATE PROCEDURE [NDTUAT].[prc_GetLPTestReportById]    
(  
...
SELECT
	...
	D.ParamDesc1 AS TechniqueName,
	E.ParamDesc1 AS ConsumablesTypeText
FROM [NDTUAT].[LiquidPenetrantExaminationTest] A
LEFT OUTER JOIN [NDTUAT].[RefDocuments] B
...
LEFT OUTER JOIN [NDTUAT].[LookUpMaster] E
...
FROM [NDTUAT].[LiquidPenetrantExaminationTestResults] A
